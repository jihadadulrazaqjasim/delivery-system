    ...
    <div class="col-md-12 col-md-offset-2">
     ...
     <!-- Begin Page Content -->
         <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 col-md-offset-2">
        <h1 class="h3 mb-2" style="text-align: center;">Drivers</h1>
        {{-- <i style="background: white;text-align: center" class="fas fa-car fa-3x"></i> --}}

            </div>
          </div> 
        <div class="table-responsive">
        <table class="table table-bordered" cellspacing="0"  width="100%" id="driversTable">
            <thead class="">
              <tr>
                <th scope="col">#</th>
...
<script src="{{URL::to('js/drivers.js')}}"></script>
