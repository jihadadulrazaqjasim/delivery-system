    ...
    <div class="col-md-12 col-md-offset-2">
        <div class="container-fluid" style="text-align: left"> 
            <h4 id="driverNameText" class="h4 mb-2" style="text-align: left;">
                <i id="icon" style="background: white;" class="fas fa-car fa-2x"></i>    
                {{$driver_name}}
        </h4> 
 
        <div class="table-responsive">
            <table class="table table-bordered" cellspacing="0"  width="100%" id="singleDriverTable">
                <thead class="">
                  <tr>
                    {{-- <th scope="col">#</th> --}}
                    <th scope="col">ID</th>
...
<script src="{{URL::to('js/singleDriver.js')}}"></script>
