...
<div class="row">
    <div class="col-md-12 col-md-offset-2">
        ...
        {{-- Accept modal --}}
        <div id="deliverConfirmationModal" class="modal fade">
 ...
 --}}
          ...
          <div class="card mb-3" style="margin:0px 10px;"> 
            ...
            <div class="card-header" style="background-color: rgb(228, 220, 220);text-" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-3"><h3>Delivered Posts</h3></div>
                </div>
        ...
        <div class="card-body" id="post_table">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="deliveredPostsTable" width="100%" cellspacing="0">
...
<script src="{{ URL::to('js/delivered.js') }}"></script>
