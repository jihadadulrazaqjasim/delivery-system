$(document).ready(function () {
    ...
    // Get All posts:::::::
    //loading datatable
    var dataTable=$('#refusedPostsTable').DataTable({
        // 'serverSide': true,
        "ajax":{ 
            url:"/getPosts",
            "data":function(data){
    ...
    $('#refusedPostsTable').on( 'draw.dt', function () {
         totalPrice=0;
         totalTransPrice=0;
